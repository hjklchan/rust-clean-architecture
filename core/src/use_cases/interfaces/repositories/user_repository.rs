use crate::{entities::user::User, use_cases::interfaces::repositories::error::UserRepositoryError};
...
pub trait UserRepository {
    ...
    fn get_by_id(&self, id: u64) -> Result<User, UserRepositoryError>;
    fn check_if_user_exist(&self, id: u64) -> Result<bool, UserRepositoryError>;
    fn check_if_email_exist(&self, email: &str) -> bool;
}